        ...
        for line, inst in Assembly_Input:
            ...
            # stores the instruction corresponding to a label
                ...
                if (LabelCheck(x) == False):
                    print("ERROR: General syntax error at line:", line)
                    return False
            ...
            if (ins[0] == "var"):
                ...
                if (First_Variable == True):
                    print(
                        "ERROR: Variables not being declared in the beginning at:", line)
                    return False
                continue
            elif (ins[0] != "var"):
            ...
            if (checkSyn(ins[0]) and OpType[ins[0]] == "E"):
                if (not checkSyn(ins[0])):
                    print(
                        "ERROR: Syntax error in instruction name or register name in line:", line)
                    return False
            ...
            if (ins[0] == "hlt"):
                ...
                if (Hlt_Handle == True):
                    print(
                        "ERROR: Halt instruction is not the last instruction at line:", line)
                    return False
